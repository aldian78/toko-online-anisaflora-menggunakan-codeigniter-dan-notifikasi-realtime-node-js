    ...
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          <div class="nav-profile-image">
            <img src="<?php echo base_url('assets_admin/img/' . $user['gambar']) ?>" alt="profile">
            <span class="login-status online"></span>
            <!--change to offline or busy as needed-->
          </div>
          <div class="nav-profile-text d-flex flex-column">
            <span class="font-weight-bold mb-2"><?php echo $user['nama']; ?></span>
            <?php if($user['level'] == 1) : ?>
      ...
      <li class="nav-item sidebar-actions">
        <span class="nav-link">
          ...
          <button class="btn btn-block btn-lg btn-gradient-success mt-4">+ Add a project</button>
          <div class="mt-4">
            <div class="border-bottom">
