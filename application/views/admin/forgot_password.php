          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form action="<?php echo base_url() . 'admin/login/forgot_password' ?>" class="pt-3" method="post">
                  <div class="form-group">
                    <input type="email" id="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                  ...
                  <div class="text-center mt-4 font-weight-light">Back to login? <a href="<?php echo base_url('admin/login') ?>" class="text-primary"> Login</a>
                  </div>
                </form>
              </div>
            </div>
